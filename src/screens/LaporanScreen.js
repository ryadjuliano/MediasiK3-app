...
import Icon from 'react-native-vector-icons/MaterialIcons'; // Pakai Material Icons, pastikan sudah install react-native-vector-icons
...
export default function LaporanScreen({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        style={styles.fab}
        onPress={() => navigation.navigate('TambahLaporan')} // Ganti dengan screen tujuan
      >
